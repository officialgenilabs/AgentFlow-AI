-- Stage E self-send guard repair
-- Reverts the temporary @lid payload_sample.sender fallback because Evolution v1.8.6
-- reports the connected instance owner there. Sending to that value produces a false
-- green self-send instead of reaching the external lead.
