...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| G01 | Production baseline certification | IN PROGRESS | Nova | Durable plan baseline | 2026-06-19T08:23Z initial directive received | Pending: `PHASE11A_PRODUCTION_DOMAIN_AUTH_CERTIFICATION.md` | None yet | Verify Git, Vercel production deployment, canonical domain, Phase 10B lineage, governance, outbound freeze, drift |
| G02 | Domain, DNS, SSL and auth callbacks | NOT STARTED | Nova | G01 PASSED | Not yet verified | Pending: `PHASE11A_PRODUCTION_DOMAIN_AUTH_CERTIFICATION.md` | G01 incomplete | Discover active domains/aliases; verify DNS/SSL/Vercel alias/Supabase redirects/callbacks |
